...
public class List_ordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StoreDataInArrays();
        customAdaptor = new CustomAdaptor(List_ordActivity.this, ord_id, date, nom_mede, specialite_mede, adress_mede, telephone_mede, mail_mede, dosage_medi, frequence_medi, nombre_boite_medi, moment_prise_medi, image_ord) {
            @Override
            public void onBindViewHolder(@NonNull CustomAdaptor.MyViewHolder holder, int position) {

            }
        };
        r.setAdapter(customAdaptor);
